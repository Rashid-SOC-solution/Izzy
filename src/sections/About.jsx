    ...
    <div className="grid grid-cols-1 md:grid-cols-2 text-center md:text-left w-full gap-24 md:gap-32 my-24 md:my-32 px-8 md:px-32">
      ...
      <div className="">
        ...
        <p className="my-4 text-[#111920] dark:text-white text-[16px]">
          ...
          fashion. Victor AI is a tool for those who lead in style and
      ...
      <div className="">
        <h2 className="text-[40px] dark:text-white capitalize leading-[48px] font-bold">
          Integrate the Power of VictorAI
        </h2>
        <p className="my-4 text-[#111920] dark:text-white text-[16px]">
          Unlock the full potential of your creative and business applications
          with the VictorAI API. Designed for seamless integration, our API
          ...
          tech-savvy designers, the VictorAI API is your gateway to
