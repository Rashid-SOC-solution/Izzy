...
function FeaturesSection() {
  return (
    <div className="relative w-full bg-[#222A32] mt-20 md:mt-48 block md:flex rounded-2xl max-w-5xl mx-auto py-5 md:py-0">
      <img
        className="block md:absolute left-10 bottom-10 mx-auto md:mx-0 mt-3 md:mt-0"
        src={phoneMockup}
      />
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 p-8 md:p-16">
        <div></div>
        <Tile
          heading="Assessment"
